...
pub async fn handle_register(
    ...
    if params.name == "Dave" {
        ...
        ctx.insert("current_pofile", &params.profile);
        ...
        let res = awc_client
            ...
            .body()
            .await?;
         let teacher_response = serde_json::from_str(&std::str::from_utf8(&res)?)?;
